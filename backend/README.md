...
## Project Structure
    ...
    ├── testapiautoconnect_102761  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_102761`
...
2. Clone this repo and `cd testapiautoconnect_102761`
